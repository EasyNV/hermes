...
- `third_party/mbs-native`: `9073187` (`client: detect dead connection for cached-holder reconnect`)
- `third_party/mautrix-meta-patched`: `d3e34d3` (`feat(messagix): expose LastLoginPayload + GetLoginIdentity for mbs-native bridge`)
